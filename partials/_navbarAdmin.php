...
<body id="body-pd">
    <header class="header bg-light shadow" id="header">
        ...
        <div><?= $fetchAdmin['nama'] ?></div>
    </header>
    <div class="l-navbar font-light" style="background-color: #5453a6;" id="nav-bar">
        <nav class="nav">
            <div> 
              <a href="#" class="nav_logo"> 
                <i class='bx bxs-coupon nav_logo-icon'></i>
                <span class="nav_logo-name">TicketEase KVKS</span> 
              </a>
              ...
              <div class="nav_list">
                <a href="senarai.php" class="nav_link"> 
                  <i class='bx bxs-user-detail nav_icon'></i> 
                  <span class="nav_name">Senarai Pembeli</span> 
                </a>
              </div>
              <div class="nav_list">
                <a href="attendance.php" class="nav_link"> 
                <i class='bx bx-spreadsheet nav_icon'></i>
                  <span class="nav_name">Pengesahan Tiket</span> 
                </a>
              </div>
              
              <?php
              if($fetchAdmin['role']==0){
              ?>
            <!-- guru -->
              <div class="nav_list">
                <a href="add_admin.php" class="nav_link"> 
                <i class='bx bx-user-plus nav_icon'></i>
                  <span class="nav_name">Tambah Pentadbir</span> 
                </a>
              </div>
              <?php
            ...
            <!-- pelajar -->
              <div class="nav_list">
                <a href="add_bus.php" class="nav_link"> 
